...
void CBubble::PopBubble()
{
	if (PopBubbleList.size() >= 3)
	{
		...
		BubbleScore += PopBubbleList.size() * 100;
...
void CBubble::PlayerPlaySound(TCHAR* _name)
{
	if (m_PlayerSoundCh == 0)
		CSoundMgr::Get_Instance()->PlaySound(_name, SOUND_POP1, SOUND_VOL1);
	else if (m_PlayerSoundCh == 1)
		CSoundMgr::Get_Instance()->PlaySound(_name, SOUND_POP2, SOUND_VOL1);
	else if (m_PlayerSoundCh == 2)
		CSoundMgr::Get_Instance()->PlaySound(_name, SOUND_POP3, SOUND_VOL1);
	else if (m_PlayerSoundCh == 3)
		CSoundMgr::Get_Instance()->PlaySound(_name, SOUND_POP4, SOUND_VOL1);
