...
void CSkiing::Initialize()
{
	...
	CSoundMgr::Get_Instance()->PlayBGM(L"MainBgm.mp3", SOUND_VOL1);
	...
	CObjMgr::Get_Instance()->Add_Object(SKIING_JUMPING_BOARD, CObjFactory<CSkiingJumpingBoard>::Create(200, 3200));
	CObjMgr::Get_Instance()->Add_Object(SKIING_JUMPING_BOARD, CObjFactory<CSkiingJumpingBoard>::Create(600, 5000));
	CObjMgr::Get_Instance()->Add_Object(SKIING_JUMPING_BOARD, CObjFactory<CSkiingJumpingBoard>::Create(300, 6500));
	CObjMgr::Get_Instance()->Add_Object(SKIING_JUMPING_BOARD, CObjFactory<CSkiingJumpingBoard>::Create(800, 8500));
	CObjMgr::Get_Instance()->Add_Object(SKIING_JUMPING_BOARD, CObjFactory<CSkiingJumpingBoard>::Create(500, 11000));
